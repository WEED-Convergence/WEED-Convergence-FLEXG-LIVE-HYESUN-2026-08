    ...
    entries: [
      ...
      },
      {
        ...
        sections: [
          ...
          { title: '라이브 단골 안내 배너', badge: 'PROMO', mark: 'promo', context: '단골 리스트',
          ...
          { title: '회원 구분 필터 · 정렬', badge: 'FILTER', mark: 'filter', context: '단골 리스트',
          ...
          { title: '선택 대상 일괄 발송', badge: 'ACTION', mark: 'actions', context: '단골 리스트',
          ...
          { title: '단골 리스트', badge: 'TABLE', mark: 'table', context: '단골 리스트',
